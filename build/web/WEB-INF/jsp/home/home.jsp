...
<table width="450" height="auto" border="0" align="center" style="margin-top: 30px; color: #5a0805; font-size: 18px;">
	...
	<tr>
		...
		<div style="float: right; padding-right: 50px; margin-top: 0px; font-size: 12px;">
                    Ainda não tem cadastro? <a href="${pageContext.request.contextPath}/cadastroPizzaria"><b>Cadastre-se</b></a><br>
                    Esqueceu a senha? <a href="#" id="verificaSenha">Clique aqui.</a>
                </div>
		</td>
	</tr>
</table>
...
<div style="display: none;" id="recuperaSenhaDialog">
    Digite o email:<br>
    <form id="formRecuperaSenha">
    <input type="text" id="email" name="pizzaria.email" />
    </form>
</div>
